...
//    }
     ...
     * @return array
     */
    public function findDepenseByLieuPaginated($etablissement, $startDate, $endDate, int $pageEnCours, int $limit, $promo = NULL): array
    {
     ...
     * @return array
     */
    public function findDepenseByLieuBySearchPaginated($etablissement, $categorie, $startDate, $endDate, int $pageEnCours, int $limit, $promo = NULL): array
    {
        // $endDate = (new \DateTime($endDate))->modify('+1 day');
        $limit = abs($limit);
        $result = [];
        $query = $this->createQueryBuilder('d')
            ...
            $query->andWhere('d.categorieDepense = :cat')
     ...
     * @return array
     */
    public function totalDepenseParPeriodeParLieu($etablissement, $startDate, $endDate, $promo = NULL): array
    {
        $endDate = (new \DateTime($endDate))->modify('+1 day');
        $query = $this->createQueryBuilder('d')
     ...
     * @return array
     */
    public function totalDepenseParPeriodeParLieuParCategorie($etablissement, $categorie, $startDate, $endDate, $promo = NULL): array
    {
        $endDate = (new \DateTime($endDate))->modify('+1 day');
        $query = $this->createQueryBuilder('d')
            ->select('SUM(d.montant) as montantTotal', 'dev.nom as nomDevise', 'dev.id as id_devise')
    ...
    public function totalDepenseParPeriodeParLieuParDevise($startDate, $endDate, $etablissement, $devise, $promo = NULL): ?float
    {
        $endDate = (new \DateTime($endDate))->modify('+1 day');
        $query = $this->createQueryBuilder('d')
    ...
    public function totalDepenseParPeriode($startDate, $endDate, $promo = NULL): array
    {
        $endDate = (new \DateTime($endDate))->modify('+1 day');
        $query = $this->createQueryBuilder('d')
