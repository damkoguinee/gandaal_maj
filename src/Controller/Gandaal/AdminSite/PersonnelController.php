...
// dd($personnel);
    ...
    #[Route('/confirm/delete/general/{id}/{etablissement}', name: 'app_gandaal_admin_site_personnel_confirm_delete_general', methods: ['GET', 'POST'])]
    public function confirmDeleteGeneral(PersonnelActif $personnelActif, Request $request, Etablissement $etablissement): Response
    {
        ...
        $route_suppression = $this->generateUrl('app_gandaal_admin_site_personnel_delete', [
            'id' => $personnelActif->getPersonnel()->getId(),
    ...
    #[Route('/gestion/acces/{etablissement}', name: 'app_gandaal_admin_site_personnel_acces', methods: ['GET'])]
    public function gestionAcces(UserRepository $userRep, InscriptionRepository $inscriptionRep, SessionInterface $session, Request $request, Etablissement $etablissement): Response
    {
        ...
        return $this->render('gandaal/admin_site/personnel/acces.html.twig', [
            'users' => $filtreUsers,
            'etablissement' => $etablissement,
            'promo' => $session->get('promo'),
            'search' => $search,
    ...
    #[Route('/gestion/acces/edit/{id}/{etablissement}', name: 'app_gandaal_admin_site_personnel_acces_edit', methods: ['GET', 'POST'])]
    public function gestionAccesEdit(User $user, InscriptionRepository $inscriptionRep, SessionInterface $session, Request $request, Etablissement $etablissement, UserPasswordHasherInterface $hasher, EntityManagerInterface $entityManager,): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {        
            ...
            return $this->redirectToRoute('app_gandaal_admin_site_personnel_acces', ['etablissement' => $etablissement->getId(), 'search' => $search], Response::HTTP_SEE_OTHER);
        }

        return $this->render('gandaal/admin_site/personnel/edit_acces.html.twig', [
            'user' => $user,
            'form' => $form,
            'etablissement' => $etablissement,
            'promo' => $session->get('promo'),
