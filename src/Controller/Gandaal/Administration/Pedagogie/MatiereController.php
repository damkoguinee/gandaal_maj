...
class MatiereController extends AbstractController
{
    ...
    public function index(MatiereRepository $matiereRep, CategorieMatiereRepository $categorieMatRep, Request $request, CursusRepository $cursusRep,  FormationRepository $formationRep, SessionInterface $session, Etablissement $etablissement): Response
    {
        ...
        if ($session->get('session_cursus')) {
            $matieres = $matiereRep->listeMatiereParCursus($session->get('session_cursus'));
        ...
        $formations = $session->get('session_cursus') ? $formationRep->findBy(['cursus' => $session->get('session_cursus')]) : $formationRep->findBy([], ['cursus' => 'ASC']);
    ...
    #[Route('/delete/{id}/{etablissement}', name: 'app_gandaal_administration_pedagogie_admin_matiere_delete', methods: ['POST'])]
