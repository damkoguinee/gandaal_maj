...
{
    #[Route('/enseignant/{etablissement}', name: 'app_gandaal_administration_secretariat_admin_enseignant_index', methods: ['GET'])]
    public function index(PersonnelActifRepository $personnelActifRep, SessionInterface $session, UserRepository $userRep, Request $request, Etablissement $etablissement): Response
    {
        ...
        return $this->render('gandaal/administration/secretariat/admin/enseignant/index.html.twig', [
            'enseignants' => $enseignants,
            'etablissement' => $etablissement
        ]);
    }

    #[Route('/new/{etablissement}', name: 'app_gandaal_administration_secretariat_admin_enseignant_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager, UserPasswordHasherInterface $hasher, SessionInterface $session, EnseignantRepository $enseignantRep, Etablissement $etablissement): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_gandaal_administration_secretariat_admin_enseignant_index', ['etablissement' => $etablissement->getId()], Response::HTTP_SEE_OTHER);
        }

        return $this->render('gandaal/administration/secretariat/admin/enseignant/new.html.twig', [
    ...
    #[Route('/show/{id}/{etablissement}', name: 'app_gandaal_administration_secretariat_admin_enseignant_show', methods: ['GET'])]
    public function show(Enseignant $enseignant, SessionInterface $session, SalaireRepository $salaireRep, DocumentEnseignantRepository $documentRep, PersonnelActifRepository $personnelActifRep, Etablissement $etablissement): Response
    {
        ...
        return $this->render('gandaal/administration/secretariat/admin/enseignant/show.html.twig', [
            'enseignant' => $enseignant,
            'salaire' => $salaire,
            'documents' => $documents,
            'etablissement' => $etablissement,
    ...
    #[Route('/edit/{id}/{etablissement}', name: 'app_gandaal_administration_secretariat_admin_enseignant_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Enseignant $enseignant, DocumentEnseignantRepository $documentRep, SalaireRepository $salaireRep, EntityManagerInterface $entityManager, UserPasswordHasherInterface $hasher, SessionInterface $session, Etablissement $etablissement): Response
    {
        ...
        return $this->render('gandaal/administration/secretariat/admin/enseignant/edit.html.twig', [
            'enseignant' => $enseignant,
            'form' => $form,
            'form_document' => $form_document,
            'form_salaire' => $form_salaire,
    ...
    #[Route('/confirm/delete/general/{id}/{etablissement}', name: 'app_gandaal_administration_secretariat_admin_enseignant_confirm_delete_general', methods: ['GET', 'POST'])]
    public function confirmDeleteGeneral(PersonnelActif $personnelActif, Request $request, Etablissement $etablissement): Response
    {
        ...
        $route_suppression = $this->generateUrl('app_gandaal_administration_secretariat_admin_enseignant_delete', [
            'id' => $personnelActif->getPersonnel()->getId(),
    ...
    #[Route('/delete/{id}/{etablissement}', name: 'app_gandaal_administration_secretariat_admin_enseignant_delete', methods: ['POST'])]
