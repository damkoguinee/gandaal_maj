        ...
        $builder
            ->add('roles', ChoiceType::class,[
                "choices"       =>  [
                    ...
                    "Secretaire-admin"           =>"ROLE_SECRETAIRE_ADMIN",
                    "Secretaire"           =>"ROLE_SECRETAIRE",
                    "Comptable-admin"           =>"ROLE_COMPTABLE_ADMIN",
                    "Comptable"           =>"ROLE_COMPTABLE",
                    "Scolarite"           =>"ROLE_SCOLARITE",
                    "Scolarite-admin"           =>"ROLE_SCOLARITE_ADMIN",
                    "Pédagogie"           =>"ROLE_PEDAGOGIE",
                    "Pédagogie-admin"           =>"ROLE_PEDAGOGIE_ADMIN",
